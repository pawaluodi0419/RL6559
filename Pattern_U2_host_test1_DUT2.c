...
u8 _by_Pattern_U2_host_test1_dut2()
{
	u8 i;
	...
	case 0x0001:
	{
		if((dut2.g_i2cRecBuf[3] & 0x07) == 0x07)
		{
			for(i=1; i<60; i++)
			{
			...
			xil_printf("dut2.pattern_u2_host_test1_pass!\r\n\r\n");
		}
		else
		{
...
//				}
	...
	{
		xil_printf("dut2.pattern_pattern_u2_host_test1_fail! fail_step = %x\r\n",dut2.g_pattern_step);
