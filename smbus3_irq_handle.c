...
u8 smbus3_irq_handle(u8 smbus_control_buf[])
{
	...
	u8  smbus3_cmd_code_add = smbus_control_buf[2];
...
//			}
	...
	//smbus_read//
	if(((smbus3_cmd_code & 0x30) == 0x30) | (smbus3_cmd_code == 0x24)  | (smbus3_cmd_code == 0x26)| ((smbus3_cmd_code == 0x01) && (smbus3_cmd_code_add == 0x04)))
	{
		switch(smbus3_process_state)
		{
		case smbus_road_waiting:
...
//			}
	...
	if(((smbus3_cmd_code == 0x01) && (smbus3_cmd_code_add == 0xda)) | (smbus3_cmd_code == 0x02) | (smbus3_cmd_code == 0x03))
	{
		switch(smbus3_process_state)
		{
		case smbus_road_waiting:
